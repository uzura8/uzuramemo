...
class Program extends MY_Controller
{
	...
	public function ajax_program_list()
	{
		// template
		$view_data = $this->_get_default_view_data();
		$view_data['list'] =  $this->model_program->get_main_list($this->offset, $this->limit, $this->_get_order_sql_clause());

		// 記事件数を取得
		$count_all = $this->model_program->get_count_all($this->search);
