...
<a href="{$smarty.const.BASE_URL}category/{$cate_list[cate].mc_id}">{$cate_list[cate].mc_name}</a>
...
<a href="{$smarty.const.BASE_URL}category/{$cate_list[cate].sc_ary[sc].mc_id}">{$cate_list[cate].sc_ary[sc].mc_name}</a>
...
<p><a href="{$smarty.const.BASE_URL}rss.xml" target="_blank"><img src="{$smarty.const.BASE_URL}img/xml2_icon.gif"></a></p>
{/if}
{if !$smarty.const.IS_AUTH}
