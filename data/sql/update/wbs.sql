...
CREATE TABLE `wbs` (
  ...
  `estimated_time` float NOT NULL DEFAULT '0' COMMENT '見積工数',
  `spent_time` float NOT NULL DEFAULT '0' COMMENT '実績工数',
  `percent_complete` tinyint(3) NOT NULL DEFAULT '0' COMMENT '進捗率',
